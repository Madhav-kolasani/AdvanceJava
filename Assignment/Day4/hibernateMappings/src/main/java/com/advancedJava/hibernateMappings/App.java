package com.advancedJava.hibernateMappings;
...
import in.cg.entities.AadharNo;
import in.cg.entities.Person;
...
public class App {
	...
	public static void main(String[] args) {
		...
		SessionFactory factory = new Configuration().configure("/in/cg/config/hibernate.cfg.xml") // if we didn't
																									// specify the path
																									// it will search
																									// hibernate.cfb in
																									// main/resources
...
//            System.out.println("User Deleted");
			...
			aad.setNumber("34456799765");

			Person p = new Person();
			p.setAadhaar(aad);
			aad.setPerson(p); // bidirectional mapping of one to one

			Profile profile = new Profile();
			profile.setProfileName("Yagna Madhav");
