...
class UserControllerTest {
	...
	void testRegisterUser() throws Exception {
		...
		Mockito.when(userService.registerUser(Mockito.any())).thenReturn("User Registered Successfully");
	...
	void testUserProfileUnauthorized() throws Exception {
		mockMvc.perform(get("/user/profile")).andExpect(status().isFound()).andExpect(redirectedUrlPattern("**/login"));
	}
